...
export const Boid = ({ startPosition, startVelocity, refs, index, group, params }: BoidParams) => {
    ...
    const behavior = () => {
        ...
        // Speed cap
        const speed = Math.sqrt(ref.velocity.x * ref.velocity.x + ref.velocity.y * ref.velocity.y)
        if (speed > MAX_SPEED) {
